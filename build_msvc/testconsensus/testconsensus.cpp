...
// bdtcoin includes.
#include <..\src\script\bdtcoinconsensus.h>
...
int main()
{
    std::cout << "bdtcoinconsensus version: " << bdtcoinconsensus_version() << std::endl;
    ...
    auto op0Result = bdtcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bdtcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
