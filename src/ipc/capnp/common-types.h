...
#ifndef BDTCOIN_IPC_CAPNP_COMMON_TYPES_H
#define BDTCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between bdtcoin processes.
...
//! Functions to serialize / deserialize common bdtcoin types.
namespace mp {
...
#endif // BDTCOIN_IPC_CAPNP_COMMON_TYPES_H
