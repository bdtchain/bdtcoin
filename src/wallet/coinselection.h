// Copyright (c) 2017-2018 The Bdtcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BDTCOIN_WALLET_COINSELECTION_H
#define BDTCOIN_WALLET_COINSELECTION_H
...
#endif // BDTCOIN_WALLET_COINSELECTION_H
