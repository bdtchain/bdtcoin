...
#ifndef BDTCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define BDTCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bdtcoin Core wallet was originally a collection of unrelated private
...
#endif // BDTCOIN_WALLET_SCRIPTPUBKEYMAN_H
