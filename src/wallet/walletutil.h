...
#ifndef BDTCOIN_WALLET_WALLETUTIL_H
#define BDTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bdtcoin from opening the wallet, thinking it was newly created, and
...
#endif // BDTCOIN_WALLET_WALLETUTIL_H
