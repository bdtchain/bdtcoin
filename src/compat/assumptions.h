...
#ifndef BDTCOIN_COMPAT_ASSUMPTIONS_H
#define BDTCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Bdtcoin cannot be compiled without assertions."
#endif
...
#endif // BDTCOIN_COMPAT_ASSUMPTIONS_H
