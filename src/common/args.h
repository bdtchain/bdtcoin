...
#ifndef BDTCOIN_COMMON_ARGS_H
#define BDTCOIN_COMMON_ARGS_H
...
extern const char * const BDTCOIN_CONF_FILENAME;
extern const char * const BDTCOIN_SETTINGS_FILENAME;
