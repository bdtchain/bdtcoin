...
#ifndef BDTCOIN_COMMON_SIGNMESSAGE_H
#define BDTCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's bdtcoin address, it must refer to a public key.
...
#endif // BDTCOIN_COMMON_SIGNMESSAGE_H
