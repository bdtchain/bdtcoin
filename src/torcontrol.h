// Copyright (c) 2015-2021 The Bdtcoin Core developers
 ...
 */
#ifndef BDTCOIN_TORCONTROL_H
#define BDTCOIN_TORCONTROL_H
...
/****** Bdtcoin specific TorController implementation ********/
