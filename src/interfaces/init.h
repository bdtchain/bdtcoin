...
#ifndef BDTCOIN_INTERFACES_INIT_H
#define BDTCOIN_INTERFACES_INIT_H
...
//! (bdtcoin-gui, bdtcoin-node, bdtcoin-wallet, bdtcoind, bdtcoin-qt) and each
...
#endif // BDTCOIN_INTERFACES_INIT_H
