 ...
 * for both bdtcoind and bdtcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Jus");


#include <bdtcoin-build-info.h>
// The <bdtcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/bdtcoin/bips/blob/master/bip-0014.mediawiki)
 */
