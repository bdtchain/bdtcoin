...
{
    // Test regression https://github.com/bdtchain/bdtcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bdtcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bdtcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Bdtcoin/Bdtcoin-Qt.conf and all else left as default,
    // bdtcoin-qt should set both -listen and -listenonion to false and start successfully.
