...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_bdtcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_bdtcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_bdtcoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BdtcoinUnits::formatWithUnit(unit, balance, false, BdtcoinUnits::SeparatorStyle::ALWAYS);
