...
//! Entry point for BdtcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BdtcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BdtcoinGUI tests.
void AppTests::guiTests(BdtcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BdtcoinGUI::consoleShown, this, &AppTests::consoleTests);
