...
/** Widget for entering bdtcoin amounts.
  */
class BdtcoinAmountField: public QWidget
{
    Q_OBJECT

    // ugly hack: for some unknown reason CAmount (instead of qint64) does not work here as expected
    // discussion: https://github.com/bdtchain/bdtcoin/pull/5117
    Q_PROPERTY(qint64 value READ value WRITE setValue NOTIFY valueChanged USER true)

public:
    explicit BdtcoinAmountField(QWidget *parent = nullptr);
...
#endif // BDTCOIN_QT_BDTCOINAMOUNTFIELD_H
