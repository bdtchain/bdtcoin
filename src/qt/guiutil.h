...
#ifndef BDTCOIN_QT_GUIUTIL_H
#define BDTCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Bdtcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bdtcoin:" URI into recipient object, return true on successful parsing
