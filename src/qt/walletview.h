...
#ifndef BDTCOIN_QT_WALLETVIEW_H
#define BDTCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a bdtcoin wallet, and offers access to
