...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BdtcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BdtcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BdtcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BdtcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BdtcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BdtcoinGUI::updateWalletStatus);
    connect(gui, &BdtcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
