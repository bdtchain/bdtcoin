      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bdtcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bdtcoinAtStartup);
    ...
    ui->bdtcoinAtStartup->setToolTip(ui->bdtcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->bdtcoinAtStartup->setText(ui->bdtcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openBdtcoinConfButton->setToolTip(ui->openBdtcoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new BdtcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bdtcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBDTControls);
...
void OptionsDialog::on_openBdtcoinConfButton_clicked()
{
