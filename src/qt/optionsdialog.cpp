    ...
    mapper(nullptr)
{
    ...
    ui->bdtcoinAtStartup->setToolTip(ui->bdtcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bdtcoinAtStartup->setText(ui->bdtcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBdtcoinConfButton->setToolTip(ui->openBdtcoinConfButton->toolTip().arg(PACKAGE_NAME));
