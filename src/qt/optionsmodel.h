...
#ifndef BDTCOIN_QT_OPTIONSMODEL_H
#define BDTCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Bdtcoin client.
...
public:
    ...
    BdtcoinUnit getDisplayUnit() const { return m_display_bdtcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSBDTControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BdtcoinUnit m_display_bdtcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BdtcoinUnit unit);
...
#endif // BDTCOIN_QT_OPTIONSMODEL_H
