...
#ifndef BDTCOIN_QT_BDTCOINGUI_H
#define BDTCOIN_QT_BDTCOINGUI_H
...
/**
  Bdtcoin GUI main class. This class represents the main window of the Bdtcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BdtcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BdtcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BdtcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bdtcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BdtcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bdtcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(BdtcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BDTCOIN_QT_BDTCOINGUI_H
