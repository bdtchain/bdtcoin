...
#ifndef BDTCOIN_ARITH_UINT256_H
#define BDTCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Bdtcoin only uses this "compact" format for encoding difficulty
