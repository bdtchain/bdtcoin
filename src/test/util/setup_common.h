// Copyright (c) 2015-present The Bdtcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BDTCOIN_TEST_UTIL_SETUP_COMMON_H
#define BDTCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/bdtchain/bdtcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // BDTCOIN_TEST_UTIL_SETUP_COMMON_H
