...
#ifndef BDTCOIN_TEST_SCRIPTNUM10_H
#define BDTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bdtcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BDTCOIN_TEST_SCRIPTNUM10_H
