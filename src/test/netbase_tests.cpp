...
{
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org", "www.bdtcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bdtcoincore.org]", "www.bdtcoincore.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org:65536", "www.bdtcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org:0", "www.bdtcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org:", "www.bdtcoincore.org:", 0, false));
}
