...
{
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org", "www.bdtcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bdtcoincore.org]", "www.bdtcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bdtcoincore.org:80", "www.bdtcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bdtcoincore.org]:80", "www.bdtcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:7393", "127.0.0.1", 7393));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:7393", "127.0.0.1", 7393));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:7393", "::ffff:127.0.0.1", 7393));
    BOOST_CHECK(TestSplitHost("[::]:7393", "::", 7393));
    BOOST_CHECK(TestSplitHost("::7393", "::7393", -1));
    BOOST_CHECK(TestSplitHost(":7393", "", 7393));
    BOOST_CHECK(TestSplitHost("[]:7393", "", 7393));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:7393", "127.0.0.1:7393"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:7393", "[::]:7393"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
