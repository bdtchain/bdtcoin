...
#ifndef BDTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define BDTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bdtcoin.
 *
 ...
 *
 * The chacha20-poly1305@bdtcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bdtcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bdtcoin are relatively fast in
...
#endif // BDTCOIN_CRYPTO_CHACHA_POLY_AEAD_H
