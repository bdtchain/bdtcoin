...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{"waitfornewblock",
                ...
                "\nMake sure to use no RPC timeout (bdtcoin-cli -rpcclienttimeout=0)",
                {
...
static RPCHelpMan getblockfrompeer()
{
    return RPCHelpMan{
        ...
        RPCExamples{
            HelpExampleCli("getblockfrompeer", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\" 0")
            + HelpExampleRpc("getblockfrompeer", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\" 0")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan getblockheader()
{
    return RPCHelpMan{"getblockheader",
                ...
                RPCExamples{
                    HelpExampleCli("getblockheader", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\"")
            + HelpExampleRpc("getblockheader", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
        ...
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
            {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "",
                {
                    ...
                    {RPCResult::Type::STR, "address", /*optional=*/true, "The Bdtcoin address (only if a well-defined address exists)"},
...
static RPCHelpMan getblock()
{
    return RPCHelpMan{"getblock",
                ...
                RPCExamples{
                    HelpExampleCli("getblock", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\"")
            + HelpExampleRpc("getblock", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    uint256 hash(ParseHashV(request.params[0], "blockhash"));
...
static RPCHelpMan gettxoutsetinfo()
{
    return RPCHelpMan{"gettxoutsetinfo",
                ...
                RPCExamples{
                    ...
                    HelpExampleCli("gettxoutsetinfo", R"("none" '"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb"')") +
                    HelpExampleCli("-named gettxoutsetinfo", R"(hash_type='muhash' use_index='false')") +
                    HelpExampleRpc("gettxoutsetinfo", "") +
                    HelpExampleRpc("gettxoutsetinfo", R"("none")") +
                    HelpExampleRpc("gettxoutsetinfo", R"("none", 1000)") +
                    HelpExampleRpc("gettxoutsetinfo", R"("none", "00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb")")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    UniValue ret(UniValue::VOBJ);
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                RPCExamples{
                    HelpExampleCli("getblockstats", R"('"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb"' '["minfeerate","avgfeerate"]')") +
                    HelpExampleCli("getblockstats", R"(1000 '["minfeerate","avgfeerate"]')") +
                    HelpExampleRpc("getblockstats", R"("00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb", ["minfeerate","avgfeerate"])") +
...
static RPCHelpMan getaddressbalance()
{
    return RPCHelpMan{"getaddressbalance",
        "\nReturns the total confirmed balance for the given address by scanning the UTXO set.\n"
        "This does not require the wallet and includes only confirmed UTXOs (mempool is not included).\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bdtcoin address to query"},
            {"minconf", RPCArg::Type::NUM, RPCArg::Default{1}, "Only include outputs confirmed at least this many blocks."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::STR, "address", "The queried address"},
                {RPCResult::Type::STR_AMOUNT, "balance", "The total confirmed balance for the address"},
                {RPCResult::Type::NUM, "utxos", "Number of matching UTXOs used to compute the balance"},
                {RPCResult::Type::NUM, "minconf", "The applied minimum confirmations filter"},
                {RPCResult::Type::NUM, "height", "The chain height at which the scan was performed"},
                {RPCResult::Type::STR_HEX, "bestblock", "The hash of the block at the tip of the chain"},
            }
        },
        RPCExamples{
            HelpExampleCli("getaddressbalance", "\"" + std::string(EXAMPLE_ADDRESS[0]) + "\"") +
            HelpExampleRpc("getaddressbalance", "\"" + std::string(EXAMPLE_ADDRESS[0]) + "\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            // Build script for the destination
            const CScript script = GetScriptForDestination(dest);

            // Reserve scan to avoid concurrent scans
            CoinsViewScanReserver reserver;
            if (!reserver.reserve()) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, "Scan already in progress, try again later");
            }
            ...
            const bool res = FindScriptPubKey(g_scan_progress, g_should_abort_scan, count, pcursor.get(), needles, coins, node.rpc_interruption_point);
            if (!res) {
                throw JSONRPCError(RPC_MISC_ERROR, "UTXO scan aborted or failed");
            }
            ...
            for (const auto& it : coins) {
                const Coin& coin = it.second;
                const int confirmations = tip->nHeight - coin.nHeight + 1;
            ...
            result.pushKV("balance", ValueFromAmount(total));
            result.pushKV("utxos", matched_utxos);
            result.pushKV("minconf", minconf);
            result.pushKV("height", tip->nHeight);
            result.pushKV("bestblock", tip->GetBlockHash().GetHex());
            return result;
        },
...
static RPCHelpMan AddressBalance()
{
    return RPCHelpMan{"addressbalance",
        "\nReturns the balance for an address split into confirmed (chain UTXO set) and unconfirmed (mempool) amounts.\n"
        "Does not require the wallet. Confirmed balance is computed from the UTXO set with a minimum confirmations filter.\n"
        "Unconfirmed balance sums unspent outputs created by mempool transactions to the address (ignores mempool spends of confirmed UTXOs).\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bdtcoin address to query"},
            {"minconf", RPCArg::Type::NUM, RPCArg::Default{1}, "Only include confirmed outputs with at least this many confirmations."},
            {"options", RPCArg::Type::OBJ_NAMED_PARAMS, RPCArg::Optional::OMITTED, "",
                {
                    {"include_confirmed", RPCArg::Type::BOOL, RPCArg::Default{true}, "Include confirmed UTXO scan"},
                    {"include_mempool", RPCArg::Type::BOOL, RPCArg::Default{true}, "Include mempool outputs"},
                },
        ...
        RPCResult{
            ...
            {
                {RPCResult::Type::STR, "address", "The queried address"},
                {RPCResult::Type::STR_AMOUNT, "confirmed", "Confirmed balance from the chain UTXO set (respecting minconf)"},
                {RPCResult::Type::STR_AMOUNT, "unconfirmed", "Unconfirmed balance from mempool outputs paying to this address (unspent in mempool)"},
                {RPCResult::Type::STR_AMOUNT, "total", "Sum of confirmed and unconfirmed"},
                {RPCResult::Type::NUM, "confirmed_utxos", "Count of confirmed UTXOs used"},
                {RPCResult::Type::NUM, "unconfirmed_utxos", "Count of unconfirmed mempool UTXOs used"},
                {RPCResult::Type::NUM, "minconf", "The applied minimum confirmations filter"},
                {RPCResult::Type::NUM, "height", "The chain height at which the confirmed scan was performed"},
                {RPCResult::Type::STR_HEX, "bestblock", "The hash of the current chain tip"},
            }
        },
        RPCExamples{
            HelpExampleCli("addressbalance", "\"" + std::string(EXAMPLE_ADDRESS[0]) + "\"") +
            HelpExampleRpc("addressbalance", "\"" + std::string(EXAMPLE_ADDRESS[0]) + "\"")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            std::string error_msg;
            ...
            const bool include_confirmed{options.exists("include_confirmed") ? options["include_confirmed"].get_bool() : true};
            ...
            const CBlockIndex* tip;
            {
                ChainstateManager& chainman = EnsureChainman(node);
                LOCK(cs_main);
                tip = CHECK_NONFATAL(chainman.ActiveChain().Tip());
            }

            CAmount confirmed_total{0};
            int confirmed_utxos{0};
            if (include_confirmed) {
                ...
                for (const auto& it : coins) {
                    ...
                    const int confirmations = tip->nHeight - coin.nHeight + 1;
                    if (confirmations >= minconf) {
                        confirmed_total += coin.out.nValue;
                        ++confirmed_utxos;
                    }
                }
            }

            CAmount unconfirmed_total{0};
            int unconfirmed_utxos{0};
            if (include_mempool) {
                try {
                    const CTxMemPool& mempool = EnsureMemPool(node);
                    LOCK(mempool.cs);
                    const auto entries = mempool.infoAll();
                    for (const auto& info : entries) {
                        const CTransactionRef& tx = info.tx;
                        const Txid txid = tx->GetHash();
                        for (size_t n = 0; n < tx->vout.size(); ++n) {
                            const CTxOut& txo = tx->vout[n];
                            if (txo.scriptPubKey == script) {
                                const COutPoint out{txid, static_cast<uint32_t>(n)};
                                if (!mempool.isSpent(out)) {
                                    unconfirmed_total += txo.nValue;
                                    ++unconfirmed_utxos;
                                }
                            }
                        }
            ...
            UniValue result(UniValue::VOBJ);
            result.pushKV("address", EncodeDestination(dest));
            result.pushKV("confirmed", ValueFromAmount(confirmed_total));
            result.pushKV("unconfirmed", ValueFromAmount(unconfirmed_total));
            result.pushKV("total", ValueFromAmount(confirmed_total + unconfirmed_total));
            result.pushKV("confirmed_utxos", confirmed_utxos);
            result.pushKV("unconfirmed_utxos", unconfirmed_utxos);
            result.pushKV("minconf", minconf);
            result.pushKV("height", tip->nHeight);
            result.pushKV("bestblock", tip->GetBlockHash().GetHex());
            return result;
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (bdtcoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{"getdescriptoractivity",
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (bdtcoin-cli -rpcclienttimeout=0)",
        {
...
static RPCHelpMan getblockfilter()
{
    return RPCHelpMan{"getblockfilter",
                ...
                RPCExamples{
                    HelpExampleCli("getblockfilter", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\" \"basic\"") +
                    HelpExampleRpc("getblockfilter", "\"00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb\", \"basic\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/bdtchain/bdtcoin/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/bdtchain/bdtcoin/issues/25675
...
static RPCHelpMan loadtxoutset()
{
    return RPCHelpMan{
        ...
        "The result is a usable bdtcoind instance that is current with the network tip in a "
        ...
        "document (<https://github.com/bdtchain/bdtcoin/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
