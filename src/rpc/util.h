...
#ifndef BDTCOIN_RPC_UTIL_H
#define BDTCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting BDTC/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1BDTC/kvB.
 */
