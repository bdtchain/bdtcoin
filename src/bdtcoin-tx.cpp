...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bdtcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bdtcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bdtcoin transaction\n" +
            "or:     bdtcoin-tx [options] -create [commands]   Create hex-encoded bdtcoin transaction\n" +
            "\n";
