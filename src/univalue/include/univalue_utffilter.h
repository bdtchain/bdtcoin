...
#ifndef BDTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BDTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BDTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
