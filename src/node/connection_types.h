...
#ifndef BDTCOIN_NODE_CONNECTION_TYPES_H
#define BDTCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/bdtcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Bdtcoin’s Peer-to-Peer Network")
...
#endif // BDTCOIN_NODE_CONNECTION_TYPES_H
