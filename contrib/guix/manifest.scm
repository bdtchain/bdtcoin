...
(define* (make-bdtcoin-cross-toolchain target
                                       #:key
...
desirable for building Bdtcoin Core release binaries."
...
;; failure; see https://github.com/bdtchain/bdtcoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-bdtcoin-cross-toolchain target)))
