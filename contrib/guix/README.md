# Bootstrappable Bdtcoin Core Builds

This directory contains the files necessary to perform bootstrappable Bdtcoin
Core builds.
...
- 24GB of free disk space on the partition that the Bdtcoin Core git repository
  resides in
...
For a Bdtcoin Core depends development environment, simply invoke
...
From the top of a clean Bdtcoin Core repository:
...
To use dongcarl's substitute server for Bdtcoin Core builds after having
