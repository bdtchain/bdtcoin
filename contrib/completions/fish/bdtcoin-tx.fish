...
# Extract options
function __fish_bdtcoin_tx_get_options
...
# Extract commands
function __fish_bdtcoin_tx_get_commands
...
complete \
    --command bdtcoin-tx \
    --condition "not __fish_bdtcoin_seen_cmd (__fish_bdtcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bdtcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bdtcoin-tx \
    --arguments "(__fish_bdtcoin_tx_get_commands)" \
    --no-files
