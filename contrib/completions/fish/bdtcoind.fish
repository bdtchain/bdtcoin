...
complete --command bdtcoind --no-files

# Extract options
function __fish_bdtcoind_get_options
...
complete \
    --command bdtcoind \
    --arguments "(__fish_bdtcoind_get_options --nofiles)"
