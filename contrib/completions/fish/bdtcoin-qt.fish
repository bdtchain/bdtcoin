...
complete --command bdtcoin-qt --no-files

# Extract options
function __fish_bdtcoinqt_get_options
...
complete \
    --command bdtcoin-qt \
    --arguments "(__fish_bdtcoinqt_get_options --nofiles)"
