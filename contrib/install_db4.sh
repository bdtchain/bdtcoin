...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the bdtcoin repository."
  exit 1
fi
...
# See https://github.com/bdtchain/bdtcoin/issues/16064
...
echo 'When compiling bdtcoind, run `./configure` in the following way:'
echo
