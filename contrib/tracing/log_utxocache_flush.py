...
"""Example logging Bdtcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bdtcoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[bdtcoind_with_usdts])
