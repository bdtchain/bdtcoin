...
declare -A LIBS
LIBS[cli]="libbdtcoin_cli.a"
LIBS[common]="libbdtcoin_common.a"
LIBS[consensus]="libbdtcoin_consensus.a"
LIBS[crypto]="libbdtcoin_crypto.a"
LIBS[node]="libbdtcoin_node.a"
LIBS[util]="libbdtcoin_util.a"
LIBS[wallet]="libbdtcoin_wallet.a"
...
# https://github.com/bdtchain/bdtcoin/issues/10102
