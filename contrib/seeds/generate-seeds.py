...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BDTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BDTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bdtcoin network\n')
    ...
    g.write('#endif // BDTCOIN_CHAINPARAMSSEEDS_H\n')
