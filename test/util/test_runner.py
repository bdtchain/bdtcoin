...
# Copyright 2016-2017 The Bdtcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for bdtcoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "bdtcoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./bdtcoin-util":
        execprog = os.getenv("BDTCOINUTIL", default=execprog)
    elif testObj["exec"] == "./bdtcoin-tx":
        execprog = os.getenv("BDTCOINTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, bdtcoin-tx
