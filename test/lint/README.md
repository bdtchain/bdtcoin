...
```sh
DOCKER_BUILDKIT=1 docker build -t bdtcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/bdtcoin -it bdtcoin-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/bdtcoin-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bdtcoin-core/leveldb-subtree.git (branch bdtcoin-fork)
* for `src/crypto/ctaes`: https://github.com/bdtcoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/bdtcoin-core/crc32c-subtree.git (branch bdtcoin-fork)
* for `src/minisketch`: https://github.com/bdtcoin-core/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/bdtcoin-core/secp256k1.git
```
