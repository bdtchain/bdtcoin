...
class TestShell:
    """Wrapper Class for BdtcoinTestFramework.

    The TestShell class extends the BdtcoinTestFramework
    ...
    class __TestShell(BdtcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BdtcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # BdtcoinTestFramework instances are supposed to be constructed with the path
