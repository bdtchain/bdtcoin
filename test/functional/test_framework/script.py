...
This file is modified from python-bdtcoinlib.
"""
...
def bn2vch(v):
    """Convert number to bdtcoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Jus codebase"""
    r = b''
