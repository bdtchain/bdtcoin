...
Verify that a bdtcoind node can use an external signer command.
...
class RPCSignerTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bdtcoind with -signer=<cmd>',
