...
class ReplaceByFeeTest(BdtcoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 BDTC/kvB <= old feerate 0.00300000 BDTC/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 BDTC - so this attempt is rejected.
