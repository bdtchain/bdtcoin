...
"""
Test starting bdtcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that bdtcoind has bound on "::1" (for RPC) and "::" (for P2P).
