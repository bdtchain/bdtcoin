...
"""Verify that starting bdtcoin with -h works as expected."""

from test_framework.test_framework import BdtcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bdtcoin with -h for help text")
        ...
        self.log.info("Start bdtcoin with -version for version information")
        ...
        self.log.info("Start bdtcoind with -fakearg to make sure it does not start")
