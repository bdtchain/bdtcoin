...
# The block reward of coinbaseoutput.nValue (50) BDTC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BDTC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bdtcoin-cli -h\" for help or \"bdtcoin-cli listwallets\" to see "
...
class TestBdtcoinCli(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bdtcoin-cli getblockchaininfo`")
        ...
        # Prevent bdtcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bdtcoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bdtcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BDTC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BDTC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BDTC) to the default wallet.
            ...
            # Test bdtcoin-cli -generate with -rpcwallet in multiwallet mode.
