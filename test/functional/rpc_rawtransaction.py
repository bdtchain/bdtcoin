...
class RawTransactionsTest(BdtcoinTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/bdtchain/bdtcoin/pull/29003
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 BDTC/kvB
        ...
        # Fee rate is 0.20000000 BDTC/kvB
