...
class TxnMallTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's balance should be starting balance, plus 50BDTC for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 BDTC for 2 matured,
