...
By default, bdtcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bdtcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
