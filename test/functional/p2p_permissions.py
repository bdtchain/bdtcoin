...
class P2PPermissionsTests(BdtcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].bdtcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].bdtcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
