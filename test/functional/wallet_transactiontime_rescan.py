...
class TransactionTimeRescanTest(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BDTC and create transactions
        ...
        # generate some bdtc to create transactions and check blockcount
        ...
        # send 10 bdtc to user's first watch-only address
        self.log.info('Send 10 bdtc to user')
        ...
        # send 5 bdtc to our second watch-only address
        self.log.info('Send 5 bdtc to user')
        ...
        # send 1 bdtc to our third watch-only address
        self.log.info('Send 1 bdtc to user')
