...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BdtcoinTestFramework
    pass


class ExampleTest(BdtcoinTestFramework):
    # Each functional test is a subclass of the BdtcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BdtcoinTestFramework class so other tests can use it."""
