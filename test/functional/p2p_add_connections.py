...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bdtcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(BdtcoinTestFramework):
    ...
    def run_test(self):
        ...
        # bdtcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bdtcoind sends its own version prior to processing
