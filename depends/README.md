...
**When configuring Bdtcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Bdtcoin Core:
...
variables will be set when generating the Bdtcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
