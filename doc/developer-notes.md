...
Bdtcoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Run with the `-testnet` option to run with "play bdtcoins" on the test network, if you
...
```shell
$ valgrind --suppressions=contrib/valgrind.supp src/test/test_bdtcoin
$ valgrind --suppressions=contrib/valgrind.supp --leak-check=full \
      --show-leak-kinds=all src/test/test_bdtcoin --log_level=test_suite
$ valgrind -v --leak-check=full src/bdtcoind -printtoconsole
...
# A coverage report will now be accessible at `./test_bdtcoin.coverage/index.html`.
```
 ...
 * [Issue #12691: Enable -fsanitize flags in Travis](https://github.com/bdtchain/bdtcoin/issues/12691)
...
- [ThreadImport (`b-loadblk`)](https://doxygen.bdtcoincore.org/init_8cpp.html#ae9e290a0e829ec0198518de2eda579d1)
  : Loads blocks from `blk*.dat` files or `-loadblock=<file>` on startup.

- [ThreadScriptCheck (`b-scriptch.x`)](https://doxygen.bdtcoincore.org/validation_8cpp.html#a925a33e7952a157922b0bbb8dab29a20)
...
- [TorControlThread (`b-torcontrol`)](https://doxygen.bdtcoincore.org/torcontrol_8cpp.html#a4faed3692d57a0d7bdbecf3b37f72de0)
...
- Net threads:
  ...
  - [ThreadMapPort (`b-upnp`)](https://doxygen.bdtcoincore.org/net_8cpp.html#a63f82a71c4169290c2db1651a9bbe249)
    : Universal plug-and-play startup/shutdown.

  - [ThreadSocketHandler (`b-net`)](https://doxygen.bdtcoincore.org/class_c_connman.html#a765597cbfe99c083d8fa3d61bb464e34)
    : Sends/Receives data from peers on port 7393.
...
Some of these are maintained by active developers of Bdtcoin Core, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Bdtcoin Core so that they can be integrated
...
- src/secp256k1
  - Upstream at https://github.com/bdtcoin-core/secp256k1/ ; actively maintained by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/bdtcoin-core/ctaes ; actively maintained by Core contributors.

- src/univalue
  - Upstream at https://github.com/bdtcoin-core/univalue ; actively maintained by Core contributors, deviates from upstream https://github.com/jgarzik/univalue
