...
Assumeutxo is a feature that allows fast bootstrapping of a validating bdtcoind
instance.
...
```
$ bdtcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bdtcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
