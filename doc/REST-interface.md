...
See [BIP64](https://github.com/bdtcoin/bips/blob/master/bip-0064.mediawiki) for
...
{
   "chainHeight" : 325347,
   "chaintipHash" : "00000364f9dbd44d7b0884864e2aa095eff120d1d5a6779bce2de9ff5fab1ebb",
   "bitmap": "1",
   "utxos" : [
      {
         "height" : 2147483647,
...
Risks
-------------
Running a web browser on the same node with a REST enabled bdtcoind can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:8332/rest/tx/1234567890.json">` which might break the nodes privacy.
