...
- Segwit addresses (bech32, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/bdtcoin/bips/blob/master/bip-0173.mediawiki)).
