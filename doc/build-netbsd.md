...
This guide describes how to build bdtcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run bdtcoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/bdtchain/bdtcoin/blob/master/doc/descriptors.md).
...
There are many ways to configure Bdtcoin Core. Here is an example that
