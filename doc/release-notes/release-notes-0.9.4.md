Bdtcoin Core version 0.9.4 is now available from:

  https://bdtcoin.org/bin/0.9.4/
...
this update is incompatible with the Bdtcoin system and could lead to consensus
forks.

Bdtcoin Core released binaries from https://bdtcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bdtcoin/+archive/ubuntu/bdtcoin
- A third-party or self-compiled Bdtcoin Core

upgrade to Bdtcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
