Bdtcoin Core version 0.16.1 is now available from:

  <https://bdtcoincore.org/bin/bdtcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bdtcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bdtcoind processes are cleaned up when tests end (sdaftuar)
