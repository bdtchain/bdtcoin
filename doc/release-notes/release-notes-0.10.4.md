Bdtcoin Core version 0.10.4 is now available from:

  <https://bdtcoin.org/bin/bdtcoin-core-0.10.4/>
...
- #6953 `43c2789` Split bdtcoin-tx into its own package
- #6953 `dfe0d4d` Include bdtcoin-tx binary on Debian/Ubuntu
