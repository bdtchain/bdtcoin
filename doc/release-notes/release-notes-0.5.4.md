Bdtcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bdtcoin/files/Bdtcoin/bdtcoin-0.5.4/
...
http://gitorious.org/bdtcoin/bdtcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bdtcoin-Qt notifications under Growl 1.3.
Increase required age of Bdtcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBdtcoin properly when installing Bdtcoin-Qt over it. (Windows)
