Bdtcoin Core version 0.13.2 is now available from:

  <https://bdtcoin.org/bin/bdtcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bdtcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bdtcoin-tx to create v2 transactions (btcdrak)
