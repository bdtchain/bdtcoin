Bdtcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bdtcoin/files/Bdtcoin/bdtcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bdtcoin
...
New/changed settings (command-line or bdtcoin.conf file)
--------------------------------------------------------
