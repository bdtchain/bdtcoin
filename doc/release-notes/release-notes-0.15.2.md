Bdtcoin Core version *0.15.2* is now available from:

  <https://bdtcoincore.org/bin/bdtcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bdtcoin-tx (TheBlueMatt)
