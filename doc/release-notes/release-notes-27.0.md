Bdtcoin Core version 27.0 is now available from:

  <https://bdtcoincore.org/bin/bdtcoin-core-27.0/>
...
- libbdtcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libbdtcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Bdtcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Bdtcoin Core would
