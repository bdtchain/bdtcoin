Bdtcoin Core version 0.9.2.1 is now available from:

  https://bdtcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BDTC to 0.01 BDTC
...
- Fix "Start bdtcoin on system login"
