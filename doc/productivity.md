...
```sh
cmake --build build --target bdtcoind bdtcoin-cli
cmake --build build --target bdtcoin-qt
cmake --build build --target bench_bdtcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bdtcoin/bdtcoin.git
```
