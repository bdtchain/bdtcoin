...
with certain assembly code from Bdtcoin Core's code. See [developer notes on sanitizers](https://github.com/bdtchain/bdtcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bdtcoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Bdtcoin Core using [`afl-fuzz`](https://github.com/google/afl):
