# PSBT Howto for Bdtcoin Core

Since Bdtcoin Core 0.17, an RPC interface exists for Partially Signed Bdtcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/bdtcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Bdtcoin transactions that are not fully signed
...
the command line in case `bdtcoin-cli` is used.
...
Later, when *V* BDTC has been received on *Amulti*, and Bob and Carol want to
