...
This guide describes how to build bdtcoind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/bdtcoin/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/bdtchain/bdtcoin/issues/6658)).
